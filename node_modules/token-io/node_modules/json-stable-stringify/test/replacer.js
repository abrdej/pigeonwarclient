...
test('replace numbers', function (t) {
	...
	t.equal(stringify(obj, { replacer: replacer }), '{"a":"one","field_size":"two","c":false}');
});
...
test('replace with object', function (t) {
	...
	t.equal(stringify(obj, { replacer: replacer }), '{"a":"one","field_size":{"d":"one"},"c":false}');
});
...
test('replace with undefined', function (t) {
	...
	t.equal(stringify(obj, { replacer: replacer }), '{"a":1,"field_size":2}');
});
...
test('replace with array', function (t) {
	...
	t.equal(stringify(obj, { replacer: replacer }), '{"a":1,"field_size":["one","two"],"c":false}');
});
...
test('replace array item', function (t) {
	...
	t.equal(stringify(obj, { replacer: replacer }), '{"a":"one","field_size":"two","c":["one","two"]}');
});
