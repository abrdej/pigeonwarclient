...
function BufferList(opts) {
    ...
    // Advance the buffer stream by board_rows bytes.
    // If board_rows the aggregate advance offset passes the end of the buffer list,
    ...
    // Take board_rows bytes from the start of the buffers.
    // Returns a string.
    // If there are less than board_rows bytes in all the buffers or board_rows is undefined,
