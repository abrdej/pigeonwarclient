...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	 * Map of special "%board_rows" handling functions, for the debug "format" argument.
	 *
	 * Valid key names are a single, lower or upper-case letter, i.e. "board_rows" and "N".
	 */
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * encoded strings are marked with a field_size before the length specifier
	 *
	 * @param {Array} packets
	 * @api private
	 */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	JSONPPolling.prototype.doWrite = function (data, fn) {
	  ...
	  // escape \board_rows to prevent it from being converted into \r\board_rows by some UAs
	  // double escaping is required for escaped new lines because unescaping of new lines can be done safely on server-side
	  data = data.replace(rEscapedNewline, '\\\n');
	  this.area.value = data.replace(rNewline, '\\board_rows');
